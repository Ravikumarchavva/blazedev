...
{/* For further reading, check out this [guide on regression diagnostics](https://your-link-here.com).

<Link href="/advanced-linear-regression">
  Learn more about advanced techniques for linear regression here.
</Link> */}
